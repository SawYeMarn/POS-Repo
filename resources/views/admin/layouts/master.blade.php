    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
         ...
         @if (Auth::user()->role == "superadmin")
            <li class="nav-item">
                <a class="nav-link" href="{{route('payment#admin')}}"><i class="fa-solid fa-credit-card"></i></i><span>Payment Method </span></a>
            </li>
         @endif

            <li class="nav-item">
                <a class="nav-link" href="{{route('order#Sale')}}"><i class="fa-solid fa-list"></i><span>Sale Information </span></a>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle" src="{{ Auth::user()->profile == null ? asset('default/profile.jpg') : asset('profile/'.Auth::user()->profile) }}"
                                    alt="Profile Image">
                            </a>
